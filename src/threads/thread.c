...
/* This compares the current ticks of the thread */
static bool compare_ticks (const struct list_elem *a,
		const struct list_elem *b,
		void *aux UNUSED);

/* This compares the current threads priorty */
...
thread_unblock (struct thread *t)
{
	...
	/* This is old implementation where it just pushed it to the back of the queue... (FIFO) */
	//list_push_back (&ready_list, &t->elem);

	/* This is my new implementation where it inserts it in a sorted queue ordered by higher priorty */
...
Multiple threads may call timer sleep() simultaneously */
	...
	list_insert_ordered(&sleep_list, &cur->elem, compare_less_ticks, NULL);
